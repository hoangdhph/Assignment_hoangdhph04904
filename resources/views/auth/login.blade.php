        	...
        	<div class="account-bg">
                <div class="card-box mb-0">
                    ...
                    <div class="m-t-10 p-20">
                        ...
                        <form class="m-t-20" action="{{route('login')}}" novalidate="" method="post">
                        	{{csrf_field()}}
							@if (session('msg'))
                            ...
                            <div class="form-group row">
                            	@if( count($errors) > 0)
										<span class="alert alert-danger col-12">{{$errors->first('email')}}</span>
								@endif
                                <div class="col-12">
                            ...
                            <div class="form-group row">
                            	@if( count($errors) > 0)
										<span class="alert alert-danger col-12">{{$errors->first('password')}}</span>
								@endif
                                <div class="col-12">
                            ...
                            <div class="form-group row m-t-30 mb-0">
                                <div class="col-12">
                                    <a href="{{route('recoverypw')}}" class="text-muted"><i class="fa fa-lock m-r-5"></i> Forgot your password?</a>
                                </div>
                            </div>
