                                    ...
                                    <form action="{{route('addproduct')}}" method="post" enctype="multipart/form-data" novalidate="">
                                        ...
                                        <div class="row">
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <select class="form-control" id="exampleSelect1" name="cate_id" value="$product->cate_id">
                                                    @foreach($cate as $ca)
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                       placeholder="Product name" name="product_name" value="{{$product->product_name}}">
                                            </fieldset>
                                            <fieldset class="form-group">
                                                @if( count($errors) > 0)
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <input type="number" class="form-control"
                                                       id="exampleInputPassword1" placeholder="Sale Price" name="sale_price" value="{{$product->sale_price}}">
                                            </fieldset>
                                            <fieldset class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <fieldset class="form-group">
                                                            ...
                                                            <input type="file" class="dropify" data-height="300" name="image" data-default-file="{{asset('upload/'.$product->image_link)}}" />
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <fieldset class="form-group">
                                                            ...
                                                            <button type="button" class="btn btn-primary waves-effect waves-light" id="btn-addimages">Add images</button><p></p>
                                                            <div class="addimages row">
                                                                @foreach($gallery as $ga)
                                                                <div class="image_upload col-md-4" >
                                                                    <input type="hidden" name="image_ids[]" value="{{$ga->id}}">
                                                                    <input type="file" name="images[]" id="img" onchange="readURL(this)" data-default-file="{{asset('upload/'.$ga->image_link)}}">
                                                                    <label for="img" class="dropify-wrapper has-preview">
                                                                        <img src="{{asset('upload/'.$ga->image_link)}}" data-default-file="{{asset('upload/'.$ga->image_link)}}" style="display: inline;">
                                                                        <button type="button" class="dropify-clear">Remove</button>
                                                                    </label>
                                                                    <input type="text" name="images_text[]" value="{{$ga->image_text}}" class="form-control">
                                                                </div>
                                                                @endforeach
                                                            </div>
                                                        </fieldset>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#btn-addimages').click(function(){
            ...
            $('.addimages').append('<div class="image_upload col-md-4" ><input type="file" name="images[]" id="img'+i+'" onchange="readURL(this)"><label class="dropify-wrapper" for="img'+i+'"><img src=""></label><input type="text" name="images_text[]" class="form-control"></div>');
        });
    });
</script>
    <script type="text/javascript">
