                                        ...
                                        <div class="row">
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                        placeholder="Name" name="name" required id="cateName" value="{{$cate->name}}">
                                            </fieldset>
                                            <fieldset class="form-group input-relative">
                                                <label >Slug</label>
                                                <input type="text" class="form-control"
                                                      placeholder="Slug" name='slug' required value="{{$cate->slug}}" id="slug">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="form-control">
                                                    ...
                                                    <textarea>{{$cate->description}}</textarea>
                                                </div>
